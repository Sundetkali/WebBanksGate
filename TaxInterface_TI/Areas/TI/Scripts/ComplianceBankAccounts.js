Nat.DIC.ComplianceBankAccounts = function (vm, options) {
    Nat.Classes.SimpleGridController.call(this, 'DIC/DIC_ComplianceBankAccounts');
    ...
    this.onGetData = function () {
        var model = null;
        if (vm.ComplianceBankAccounts)
            model = vm.ComplianceBankAccounts.options.model;
        return {
    ...
    this.onEdit = function(e) {
        if (e.model.isNew() && vm.clients) {
            var model = vm.ComplianceBankAccounts.getSelected();
