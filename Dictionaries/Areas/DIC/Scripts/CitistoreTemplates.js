Nat.DIC.CitistoreTemplates = function (vm, options) {
    Nat.Classes.SimpleGridController.call(this, 'DIC/DIC_CitistoreTemplates');
    ...
    this.onGetData = function () {
        return {
            model: vm.DIC_CitistoreTemplates.options.model
        };
    };
