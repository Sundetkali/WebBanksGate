Nat.DIC.BankAccountTypes = function(vm, options) {
    Nat.Classes.SimpleGridController.call(this, 'DIC/DIC_BankAccountTypes');
    ...
    this.onGetData = function () {
        var model = null;
        if (vm.BankAccountTypes)
            model = vm.BankAccountTypes.options.model;
        return {
    ...
    this.onEdit = function (e) {
        if (e.model.isNew() && vm.clients) {
            var model = vm.BankAccountTypes.getSelected();
