Nat.DIC.ComplianceEKNPTreasurys = function (vm, options) {
    Nat.Classes.SimpleGridController.call(this, 'DIC/DIC_ComplianceEKNPTreasurys');
    ...
    this.onGetData = function () {
        var model = null;
        if (vm.ComplianceEKNPTreasurys)
            model = vm.ComplianceEKNPTreasurys.options.model;
        return {
    ...
    this.onEdit = function(e) {
        if (e.model.isNew() && vm.clients) {
            var model = vm.ComplianceEKNPTreasurys.getSelected();
